...
from Bot.handlers.order.admin_panel import panel, redact_showmodels, redact_addmodel,redact_images, redact_utils, change_models
...
async def run():
	...
	dp.include_routers(panel.router , redact_showmodels.router, redact_utils.router, redact_images.router, redact_addmodel.router, change_models.router)